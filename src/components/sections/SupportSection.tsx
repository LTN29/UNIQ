        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 md:mb-24 gap-8">
          <div>
            ...
            <p className="text-3xl md:text-4xl lg:text-5xl font-display font-light text-graphite leading-tight max-w-2xl">
              {t('supportSection.title1')}
              <span className="font-editorial italic">{t('supportSection.title2')}</span>
            </p>
          </div>
        </div>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-8 md:gap-16 mb-6 md:mb-0 md:w-1/2">
                  ...
                  <h3
                    className={`text-2xl md:text-3xl font-display font-medium transition-colors ${isFirst ? 'text-brand-red' : 'text-graphite group-hover:text-brand-red'}`}
                  >
                    {t(item.title)}
                  </h3>
                </div>
                ...
                <div className="mt-8 md:mt-0 flex justify-end md:w-1/6">
                  <span className="relative overflow-hidden inline-block text-sm font-mono tracking-widest uppercase">
                    <span className="block transition-transform duration-500 group-hover:-translate-y-full text-graphite/50">
                      {t('supportSection.explore')}
                    </span>
