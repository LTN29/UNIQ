  ...
  return (
    ...
    >
      <Container className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        <div
          ref={textLinesRef}
          className="lg:col-span-6 relative z-20 flex flex-col justify-center"
        >
          ...
          <h1 className="text-5xl md:text-6xl lg:text-[4.5rem] font-display font-semibold text-graphite leading-[1.1] tracking-tight mb-10 relative z-30">
            ...
            <div className="overflow-hidden pb-4 -mb-4">
              <span className="block font-editorial font-light italic text-graphite/90">
                {t('hero.title2')}
              </span>
            </div>
          ...
          <div className="overflow-hidden">
            <div className="flex flex-wrap gap-8 items-center">
              <a
                href="#products"
                className="group inline-flex items-center gap-4 font-mono text-xs uppercase tracking-widest text-graphite"
              >
                <span className="relative overflow-hidden">
                  <span className="block transition-transform duration-500 group-hover:-translate-y-full">
                    {t('hero.explore')}
                  </span>
                  <span className="absolute inset-0 block transition-transform duration-500 translate-y-full group-hover:translate-y-0 text-brand-red">
                    {t('hero.explore')}
                  </span>
                </span>
              ...
              <a
                href="#technology"
                className="group inline-flex items-center gap-4 font-mono text-xs uppercase tracking-widest text-muted-foreground"
              >
                <span className="transition-colors duration-300 group-hover:text-graphite">
                  {t('hero.tech')}
                </span>
              </a>
            </div>
